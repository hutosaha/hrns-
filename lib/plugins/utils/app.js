...
app.calculateFee = (salary) => {
    ...
    return '£' + parseInt(numberString) * 0.15;
}
app.filterHarnessTalent = () => {
    ...
    let checkCandidate = (candidate, i) => {
        ...
        for (var i = 0; i < filterKeys.length; i++) {
            ...
            return candidate[filterKeys[i]] === query[filterKeys[i]] && candidate[filterKeys[i + 1]] === query[filterKeys[i + 1]]
        }
