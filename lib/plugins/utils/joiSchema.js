...
app.interviewSchema = {
    firstIntDate: Joi.string(),
    firstIntTime : Joi.string(),
    secondIntDate :Joi.string(),
    secondIntTime: Joi.string(),
    thirdIntDate: Joi.string(),
    thirdIntTime: Joi.string(),
    additionalComments: Joi.string().max(1000),
    interviewAddress: Joi.string()
};
