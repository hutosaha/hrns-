...
mailgun.emailAdminHarnessTalentCv = {
  ...
  html:'An agency has submitted a new candidate for Harness Talent <a href="www.harnesstalent.com/adminharnesstalent">click to view</a>',
  to: admin // TODO change to admin email address
}
...
mailgun.adminApprovedForHarnessTalent = {
  ...
  html:'Your candidate has been accpeted for Harness Talent',
  to: admin
}
