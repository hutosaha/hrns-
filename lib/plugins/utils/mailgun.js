...
const agencySubmittedCandidateHarnessTalent = fs.readFileSync('./lib/emails/agencySubmittedCandidateHarnessTalent').toString();
const adminApprovedForHarnessTalent         = fs.readFileSync('./lib/emails/adminApprovedForHarnessTalent.html').toString();
