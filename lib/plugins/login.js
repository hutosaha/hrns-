        ...
        config: {
            ...
            handler: (request, reply) => {
                ...
                if (request.auth.isAuthenticated) {
                    ...
                    console.log('AUTHENTICATED', userType, request.query);
                    ...
                    } else if (userType === 'interview/email'){
                      request.cookieAuth.set('interviewId', userType );
                      reply.redirect('/interview/email');
                    } else {
