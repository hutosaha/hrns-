...
//consts CronJob = require('cron').CronJob;
                ...
                config: {
                    ...
                    handler: (request, reply ) => {
                        getSetMembersInfo('HarnessTalent', (array) => {
                                      ...
                                      {
                                          const initial = arrayItem.dateSubmitted;
                                          const formattedDate = moment(initial).add(35, 'days').calendar();
                                          console.log(initial, formattedDate);


                                      if(initial > formattedDate){
                                      console.log( 'initial larger than formatted');
                                      }
                                      if(initial < formattedDate){
                                          console.log( 'initil smaller');
                                      }
