...
const emailCandidateSelfSubmittedCv = require('../utils/mailgun.js').emailCandidateSelfSubmittedCv;
  ...
  server.route([{
    ...
    config: {
      ...
      handler: (request, reply) => {
          ...
          console.log('IN THE HOUSE', payload, id);

            client.saddAsync('candidatesSelfSubmitted' , id )
             .then(()=>{               
                let contextAdmin = Object.assign({}, emailAdminSelfSubmittedCv );              
                ...
                let contextCandidate = Object.assign({}, emailCandidateSelfSubmittedCv );              
                contextCandidate.html = contextCandidate.html
                  .replace('-candidateName-', payload.candidateName)
                contextCandidate.to = payload.email;
