...
exports.register = (server, options, next) => {
    ...
    server.route([

         {
            ...
            config: {
                ...
                handler: (request, reply) => {
                    ...
                    //  interview Id need to be registered under cvid set & 
        ...
        {
            method: 'GET',
            path:'/scheduling/pendinginterviews/{clientId*}',
            config: {
                auth: false,
                handler: (request, reply) => {
                    let opts     = { title: 'Pending Interviews' };
                    let layout   = { layout: 'client' };
                    let pendingInterviews = request.params.clientId +'InterviewsRequested';
