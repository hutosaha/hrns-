...
exports.register = (server, options, next) => {
    ...
    server.route([

        {
            ...
            config: {
                ...
                handler: (request, reply) => {
                    ...
                    getInterviewDetails(interview, (interviewData) => {  
                        if (interviewData) {
            ...
            config: {
              ...
              handler: (request,reply) => {
                ...
                if(cookie){
                    ...
                    request.cookieAuth.set('interviewId', interviewId );
                    let opts   = { interviewId: interviewId,  title: 'Login'};
                    return reply.view('interviewlogin', opts, layout);
      ...
      /*  {
            method: 'GET',
            path: '/interview/confirmation/{interviewId}',
            config: {
                auth: {
                    strategies: ['hrns-cookie']
                },
                handler: (request, reply) => {
