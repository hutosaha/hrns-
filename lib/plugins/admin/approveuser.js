                  ...
                  if (res) {            
                    ...
                    if (verdict === 'approve') {
                        ...
                        addRemoveFromSets('rejectedUsers', 'awaitingApproval', id, (res) => {
                            if (res) {
                                let newRejectedUser  = Object.assign({}, rejectedUser);
                                
                                newRejectedUser.to   = request.params.email;
                                newRejectedUser.html = newRejectedUser.html.replace('-firstName-', firstName);
                                mailgun.messages().send(newRejectedUser); // this isn't dependent on sending email. 
