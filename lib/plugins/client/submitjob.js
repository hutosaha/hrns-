                    ...
                    if (res) {
                        getSetMembers('agencyEmails', (res) => {
                            if (res) {
                                ...
                                opts.message = 'Great job! Your vacancy will go live in Harness in 24 hours, and you can expect to start seeing CV’s in 48 hours. Now sit back and relax, let us do the hard work!';
