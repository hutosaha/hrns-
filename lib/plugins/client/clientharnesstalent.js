                    ...
                    handler: (request, reply) => {
                        ...
                        getSetMembersInfo(set, (harnessTalentList) => {
                            ...
                            if(Object.keys(harnessTalentList).length === 0  || Object.keys(query).length === 0) {
                                ...
                                function checkCandidate(candidate, i ){
                                    for(var i =0; i< filterKeyExcSalary.length; i++){
                                        candidate[filterKeyExcSalary[i]] === query[filterKeyExcSalary[i]] && 
                                ...
                                console.log('fitleredResponse', filteredResponse);
                                ...
                                response.array = filterHarnessTalent(query, harnessTalentList);
                                reply(response);                                    
