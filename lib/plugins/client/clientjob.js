    ...
    server.route([{
          ...
          config: {
            ...
            handler: (request, reply) => {
              ...
              emailAgencyOnClientShortlistAcceptance.to = agencyEmail;
              emailAgencyOnClientShortlistAcceptance.subject = 'Great news!'+ candidateName+' has been accepted';
              
              emailAgencyOnClientShortlistAcceptance.html = emailAgencyOnClientShortlistAcceptance.html.replace('-candidateName-', candidateName);
              emailAgencyOnClientShortlistAcceptance.html = emailAgencyOnClientShortlistAcceptance.html.replace('-jobTitle-', jobTitle);
              ...
              addRemoveFromSets( vid+'stageOne', vid +'clientShortlist', cvid , (res) => {
                    if(res){
                      ...
                      mailgun.messages().send(emailAgencyOnClientShortlistAcceptance);                  
                      reply(true);
                    } else {
                      reply(false);
                    }
