    ...
    server.route([{
        ...
        config: {
            ...
            handler: (request, reply) => {
                ...
                let set;
                console.log('VID', vid , 'QUERY', request.query);
                getHash(vid, (res) => {
                    if (!res) {
                        return reply(false);
                    }
                    ...
                    getHash(cvid, (res) => {
                        ...
                        agencyDetails.from = 'Harness <hello@harnesstalent.com>';
                        agencyDetails.subject = "Your candidate hasn't been approved by the client...",
                            agencyDetails.html = emailAgencyOnClientShortlistRejection
