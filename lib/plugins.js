...
// const Cron            		= require('./plugins/crontimer.js');
const Agencyharnesstalent	= require('./plugins/agency/agencyharnesstalent.js');
const Clientharnesstalent	= require('./plugins/client/clientharnesstalent.js');
const Adminharnesstalent 	= require('./plugins/admin/adminharnesstalent.js');
const Interviews      	 	= require('./plugins/interview.js');
const Removeuser         = require('./plugins/admin/removeuser.js');
...
module.exports = [ Blipp, Inert, Vision, Home, Login, Candidate, Client, ClientSignUp, AdminDashboard,
Logout, AdminVacancies, ApproveUsers, ApproveUser, UserInfo, AgencyLogin, Agency, AgencySignUp,
...
Agencyharnesstalent, Clientharnesstalent, Removeuser];
