...
server.init(0, (err, server) => {
    ...
    testPayload('/' + agencyLoginEndPoint, 'GET', 'Agency Login', 'correctly returns agency login view');
    ...
    testPayload('/client/job/randomvid', 'GET', 'Client\'s Job Page', 'payload contains view with:', clientCookie);
    ...
    testEndPoint('/login/client', 'GET', 302, 'auth non-existing client redirects to signup', nonExistingUserCookie);
    testHeaderLocation('/login/client', 'GET', '/clientsignup', 'redirects to client signup form', nonExistingUserCookie);
