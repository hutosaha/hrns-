...
const query = 'reason=Not%20enough%20experience&vid=testvid&cvid=testcvid&list=testclientShortlist'
...
server.init(0, (err, server) => {
    ...
    client.select(3, () => {
        ...
        //we will then test the harnesstalent/results endpoint to see if the returned array matches the query. 
